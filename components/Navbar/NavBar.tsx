    ...
    <>
      ...
      >
        <div className="flex items-center gap-4">
          ...
          <div className="hidden items-center gap-4 text-base font-medium md:flex">
            <Link
        ...
        <div className="flex items-center gap-4">
          ...
          <button
            type="button"
            className="text-foreground/80 hover:text-foreground flex items-center justify-center p-2 transition-colors md:hidden"
      ...
      {isMobileMenuOpen && (
        <div className="bg-background fixed inset-0 top-[80px] z-40 flex flex-col items-center justify-start pt-20 md:hidden">
          <Link
