...
const ProblemSolving = () => {
  return (
    <section id="problem-solving" className="mx-auto mt-12 max-w-3xl px-0 sm:mt-16">
      ...
      <div className="mb-8">
        ...
        <p className="mt-4 max-w-2xl text-base leading-relaxed text-neutral-600 dark:text-neutral-400">
          I believe writing good software requires a strong foundation in Data Structures & Algorithms. I regularly practice on LeetCode to keep my logical thinking sharp.
        </p>
      </div>

      {/* Main LeetCode Card */}
      <div className="group relative overflow-hidden rounded-3xl border border-neutral-200 bg-neutral-50 p-6 transition-all duration-300 hover:border-neutral-300 hover:shadow-sm dark:border-neutral-800 dark:bg-neutral-900/50 dark:hover:border-neutral-700">
        
        {/* Profile Header */}
        <div className="mb-8 flex items-center justify-between">
          <div className="flex items-center gap-4">
            <div className="relative flex h-12 w-12 shrink-0 items-center justify-center overflow-hidden rounded-2xl border border-neutral-200 bg-white dark:border-neutral-800 dark:bg-neutral-900">
              <Image 
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
          {leetcodeStats.map((stat, idx) => (
            <div 
              key={idx} 
              className="relative flex flex-col rounded-2xl border border-neutral-200 bg-white p-4 transition-all duration-300 hover:-translate-y-1 dark:border-neutral-800/60 dark:bg-neutral-900/80"
            >
      ...
      <hr className="my-12 border-neutral-200 dark:border-neutral-800 sm:my-16" />
    </section>
  );
};
