  ...
  return (
    ...
    <div className="mt-8 flex items-center gap-4">
      ...
      <div className="relative">
        <motion.div
          initial={false}
          // Added a subtle scale effect to the popup card animation
          animate={xHover ? { opacity: 1, y: 0, scale: 1 } : { opacity: 0, y: 10, scale: 0.95 }}
          transition={{ duration: 0.2, ease: "easeOut" }}
          // Centered the popup over the icon (-translate-x-1/2) and added z-50 so it doesn't hide behind other sections
          className="pointer-events-none absolute bottom-10 left-1/2 z-50 hidden w-[300px] -translate-x-1/2 md:block"
        >
      ...
      <div className="relative">
        <motion.div
          initial={false}
          animate={linkedinHover ? { opacity: 1, y: 0, scale: 1 } : { opacity: 0, y: 10, scale: 0.95 }}
          transition={{ duration: 0.2, ease: "easeOut" }}
          className="pointer-events-none absolute bottom-10 left-1/2 z-50 hidden w-[300px] -translate-x-1/2 md:block"
        >
